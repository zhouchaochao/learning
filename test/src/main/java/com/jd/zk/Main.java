...
public class Main {
    ...
    public static void main(String[] agrs){
        try{
            ...
            String ip = null;//NetUtils.getLocalAddress().getLocalHost().getHostAddress();
...
*/
    ...
    public static void registerScheduleServer(final ScheduleServer server) throws Exception {
        ...
        boolean exists = false;//zkClient.exists(zkPath);
    ...
    public static String getMasterId(String workerType){
        try{
            ...
            List<String> childs = null;//zkClient.getChildren(zkPath);
